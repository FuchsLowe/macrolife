...
import com.fuchsundlowe.macrolife.ComplexGoal.TailView;
...
public class ComplexTaskChevron extends View  implements ScaleInterface {
    ...
    public void setNewScale(float newScale) {
        ...
        currentLayout.left = this.getLeft();
        currentLayout.top = this.getTop();
    ...
    public boolean isRepeatingTask() {
        return data instanceof RepeatingEventMaster;
    }
